...
public fun HtmlBodyTag.text(h : highlight, body: P.()->Unit) : Unit = p(s("text-${h.name()}"), contents = body)

public fun HtmlBodyTag.panel(h : highlight, body: DIV.()->Unit) : Unit = div(s("panel panel-${h.name()}"), contents = body)
