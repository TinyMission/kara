...
fun HtmlBodyTag.blockAction(h: highlight = highlight.default, body: A.()->Unit): Unit = a {
...
fun HtmlBodyTag.action(url: Link, h: highlight = highlight.default, size: caliber = caliber.default, body: A.()->Unit): Unit = action(h, size) { href = url; body() }

fun HtmlBodyTag.bt_button(h: highlight = highlight.default, size: caliber = caliber.default, body: BUTTON.()->Unit): Unit = button {
    addClass("btn")
